...
* Security.yaml specifies which URIs require authentication
* Change the CustomAuthenticator that is generated and specify what route to redirect to after the user logs in.
...
You then need to put a user in the table.  The password in the table needs to be hashed.
